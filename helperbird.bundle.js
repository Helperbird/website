...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1), __webpack_require__(5).setImmediate))
...
// NAMESPACE OBJECT: ./assets/js/core/scanner.js
var scanner_namespaceObject = {};
__webpack_require__.r(scanner_namespaceObject);
__webpack_require__.d(scanner_namespaceObject, "scanPage", function() { return scanPage; });
__webpack_require__.d(scanner_namespaceObject, "setup", function() { return setup; });

// NAMESPACE OBJECT: ./assets/js/core/notifactions.js
var notifactions_namespaceObject = {};
__webpack_require__.r(notifactions_namespaceObject);
__webpack_require__.d(notifactions_namespaceObject, "popup", function() { return popup; });

// EXTERNAL MODULE: ./assets/css/styles.css
var styles = __webpack_require__(2);

// EXTERNAL MODULE: ../node_modules/tiny-slider/dist/tiny-slider.css
var tiny_slider = __webpack_require__(3);

// EXTERNAL MODULE: ../node_modules/notyf/notyf.min.css
var notyf_min = __webpack_require__(4);

// CONCATENATED MODULE: ./assets/js/core/youtube.js
 function load() {
...
// CONCATENATED MODULE: ./assets/js/core/slider.js



async function slider_start() {
...
// CONCATENATED MODULE: ./assets/js/core/scanner.js
let eventArray = [];

async function scanPage(context, errorCallback, options) {
...
var NotyfView = /** @class */ (function () {
    ...
    NotyfView.prototype._buildNotificationCard = function (notification) {
        ...
        if (options.dismissible) {
            ...
            dismissButton.addEventListener('click', function () { var _a; return (_a = _this.events) === null || _a === void 0 ? void 0 : _a[NotyfEvent.Dismiss](notification); });
        }
...
var Notyf = /** @class */ (function () {
    function Notyf(opts) {
        ...
        this.view.on(NotyfEvent.Dismiss, function (elem) { return _this._removeNotification(elem); });
    }
...
// CONCATENATED MODULE: ./assets/js/core/notifactions.js


const notifactions_notyf = new Notyf({
    ripple: true,
    duration: 5000,
    position: {
      x: 'center',
...
async function popup(message) {
	setTimeout(() => {
        notifactions_notyf.success(message);
	}, 2000), {
		once: true
	}
...
// CONCATENATED MODULE: ./assets/js/core/navigation.js
...
// CONCATENATED MODULE: ./assets/js/core/extension-pricing.js




async function extension_pricing_load() {
...
// CONCATENATED MODULE: ./assets/js/core/widget-pricing.js




async function widget_pricing_load() {
...
// CONCATENATED MODULE: ./assets/js/core/a11y-pricing.js





async function a11y_pricing_load() {
...
window.notifactions = notifactions_namespaceObject;
window.a11y = scanner_namespaceObject;
