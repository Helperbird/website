...
description:
  Learn how to add a colored overlay to any website using Helperbird. Color overlays can reduce eye strain and make reading more comfortable, especially for people with dyslexia or Irlen Syndrome.
keywords:
...
headerTags:
  [
    { tag: 'what-is-a-color-overlay', title: 'What is a Color Overlay?' },
    ...
    { tag: 'step-3-find-dyslexia-support', title: 'Step 3: Find Dyslexia Support' },
    { tag: 'step-4-open-dyslexia-support', title: 'Step 4: Open Dyslexia Support' },
    { tag: 'step-5-turn-on-overlay', title: 'Step 5: Turn on Overlay' },
    { tag: 'step-6-customize-the-overlay', title: 'Step 6: Customize the Overlay' },
    { tag: 'overlay-settings', title: 'Overlay Settings' },
