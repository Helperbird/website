...
header: true
updated: true
title: How to Use Reading Mode on Any Website
description:
...
headerTags:
  [
    { tag: 'what-is-reading-mode', title: 'What is Reading Mode?' },
    ...
    { tag: 'step-3-find-reading-mode', title: 'Step 3: Find Reading Mode' },
    { tag: 'step-4-click-reading-mode', title: 'Step 4: Click Reading Mode' },
    { tag: 'step-5-customize-your-view', title: 'Step 5: Customize Your View' },
    { tag: 'step-6-exit-reading-mode', title: 'Step 6: Exit Reading Mode' },
