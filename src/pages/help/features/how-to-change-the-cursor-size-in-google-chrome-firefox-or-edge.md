...
updated: true
title: How to Change Cursor Size on Any Website
description:
  Learn how to make your mouse cursor larger using Helperbird. A bigger cursor is easier to see and track on the screen.
keywords:
...
headerTags:
  [
    { tag: 'what-is-cursor-size', title: 'What is Cursor Size?' },
    ...
    { tag: 'step-5-turn-on-cursor-size', title: 'Step 5: Turn on Cursor Size' },
    { tag: 'step-6-adjust-the-size', title: 'Step 6: Adjust the Size' },
