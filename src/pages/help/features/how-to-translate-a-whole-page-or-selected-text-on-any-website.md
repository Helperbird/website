...
header: true
updated: true
title: How to Translate Any Website to Another Language
description:
  Learn how to translate any website into your language using Helperbird. Translate entire pages or just selected text using Google Translate.
keywords:
...
headerTags:
  [
    { tag: 'what-is-translate', title: 'What is Translate?' },
    ...
    { tag: 'step-3-find-translate', title: 'Step 3: Find Translate' },
    { tag: 'step-4-choose-your-language', title: 'Step 4: Choose Your Language' },
    { tag: 'step-5-translate-the-page', title: 'Step 5: Translate the Page' },
