...
description:
  Learn how to change the color that appears when you select text on any website using Helperbird. Choose a selection color that works better for you.
keywords:
  Dyslexia software, Reading Mode for Google Chrome, Voice typing for chrome, Text to speech for
  chrome, text reader, Immersive Reader, dyslexia fonts, accessibility software, dyslexia software,
  Helperbird for Edge, Helperbird for Firefox, Helperbird for Chrome, Opendyslexic for Chrome,
  OpenDyslexic, highlight color, text highlighting, selection color
...
headerTags:
  [
    { tag: 'what-is-selection-highlight-color', title: 'What is Selection Highlight Color?' },
