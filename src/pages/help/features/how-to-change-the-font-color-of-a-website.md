...
updated: true
title: How to Change Text Color on Any Website
description:
...
headerTags:
  [
    { tag: 'what-is-text-color', title: 'What is Text Color?' },
    ...
    { tag: 'step-6-turn-on-text-color', title: 'Step 6: Turn on Text Color' },
