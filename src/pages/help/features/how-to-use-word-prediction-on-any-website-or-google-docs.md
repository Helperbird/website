...
header: true
updated: true
title: How to Use Word Prediction on Any Website
description:
...
headerTags:
  [
    { tag: 'what-is-word-prediction', title: 'What is Word Prediction?' },
    ...
    { tag: 'step-3-find-word-prediction', title: 'Step 3: Find Word Prediction' },
    { tag: 'step-4-turn-on-word-prediction', title: 'Step 4: Turn on Word Prediction' },
    { tag: 'step-5-adjust-settings', title: 'Step 5: Adjust Settings' },
    { tag: 'step-6-start-typing', title: 'Step 6: Start Typing' },
...
As you type, a bar will appear at the bottom of the screen showing word suggestions. These are words that match what you have typed so far.
