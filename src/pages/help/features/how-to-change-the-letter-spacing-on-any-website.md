...
description:
  Learn how to increase the space between letters on any website using Helperbird. Letter spacing makes text easier to read, especially for people with dyslexia.
keywords:
  Dyslexia software, Reading Mode for Google Chrome, Voice typing for chrome, Text to speech for
  chrome, text reader, Immersive Reader, dyslexia fonts, accessibility software, dyslexia software,
  Helperbird for Edge, Helperbird for Firefox, Helperbird for Chrome, Opendyslexic for Chrome,
  OpenDyslexic, letter spacing, character spacing, text spacing, dyslexia reading
...
headerTags:
  [
    { tag: 'what-is-letter-spacing', title: 'What is Letter Spacing?' },
    ...
    { tag: 'step-5-turn-on-letter-spacing', title: 'Step 5: Turn on Letter Spacing' },
