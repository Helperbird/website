...
headerTags:
  [
    { tag: 'what-is-extract-text', title: 'What is Extract Text?' },
    ...
    { tag: 'step-3-find-extract-text', title: 'Step 3: Find Extract Text' },
    { tag: 'step-4-open-extract-text', title: 'Step 4: Open Extract Text' },
    { tag: 'step-5-configure-options', title: 'Step 5: Configure Options' },
    { tag: 'step-6-select-the-area', title: 'Step 6: Select the Area' },
    { tag: 'step-7-use-the-extracted-text', title: 'Step 7: Use the Extracted Text' },
