    ...
    <div class="lg:grid lg:grid-cols-2 lg:gap-8">
      ...
      >
        <div class="lg:py-24">
          ...
          >
            <span class="block"> Privacy features of Helperbird</span>
          </h1>
          <p
            class="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
          >
            Helperbird will never sell, store, or consume any user data. We do
            not store data or any other user-related content.
          </p>
