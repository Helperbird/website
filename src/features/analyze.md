    ...
    <div class="lg:grid lg:grid-cols-2 lg:gap-8">
      ...
      >
        <div class="lg:py-24">
          ...
          >
            <span class="block">Analyze text, webpages quickly and faster</span>
          </h1>
          <p
            class="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
          >
            Two clicks, find the number of letters, characters, and more on any
            website. Making writing quicker and easier with our amazing browser
            extension.
          </p>
