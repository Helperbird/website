    ...
    <div class="lg:grid lg:grid-cols-2 lg:gap-8">
      ...
      >
        <div class="lg:py-24">
          ...
          >
            <span class="block"
              >Display Alt and title tags on mouse hover
            </span>
          </h1>
          <p
            class="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
          >
            Discover Alt and title tags on every website with Helperbird.
            Through the use of tooltips, discover missing alt tags on hover and
            display them on mouse hover.
          </p>
